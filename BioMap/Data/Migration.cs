        ...
        foreach (var el in aElements) {
          ...
          switch (nCat.HasValue ? nCat.Value : 0) {
            ...
            case 140:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Anura") },
              };
              break;
            case 141:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Bufo bufo") },
              };
              break;
            case 150:
              el.Classification = new ElementClassification {
            ...
            case 151:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Rana temporaria") },
              };
              break;
            case 152:
              el.Classification = new ElementClassification {
            ...
            case 153:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Pelophylax") },
              };
              break;
            case 160:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Caudata") },
              };
              break;
            case 161:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Lissotriton vulgaris") },
              };
              break;
            case 162:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Ichthyosaura alpestris") },
              };
              break;
            case 163:
              el.Classification = new ElementClassification {
            ...
            case 164:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Salamandra salamandra") },
              };
              break;
            case 170:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Insecta") },
              };
              break;
            case 173:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Nepa cinerea") },
              };
              break;
            case 174:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Odonata"), Stadium = ElementClassification.Stadium.Larvae },
              };
              break;
            case 210:
              el.Classification = new ElementClassification {
            ...
            case 342:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Bombina variegata"), Stadium = ElementClassification.Stadium.Eggs },
              };
              break;
            case 244:
            case 344:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Bombina variegata"), Stadium = ElementClassification.Stadium.Larvae },
              };
              break;
            case 320:
              el.Classification = new ElementClassification {
            ...
            case 340:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Bombina variegata"), Stadium = ElementClassification.Stadium.Adults },
              };
              break;
            case 346:
              el.Classification = new ElementClassification {
                ClassName = "Living being",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Bombina variegata"), Stadium = ElementClassification.Stadium.Deads },
              };
              break;
            case 350:
              el.Classification = new ElementClassification {
                ClassName = "ID photo",
                LivingBeing = new ElementClassification.LivingBeing_t { Taxon = sd.CurrentProject.GetTaxon("Bombina variegata"), Stadium = el.GetWinters() < 2 ? ElementClassification.Stadium.Juveniles : ElementClassification.Stadium.Adults },
              };
              break;
            case 351:
              el.Classification = new ElementClassification {
